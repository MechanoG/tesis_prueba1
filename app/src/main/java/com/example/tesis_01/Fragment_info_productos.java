...
public class Fragment_info_productos extends Fragment {
    ...
    String url_masvendidos = "http://192.168.0.2/tesis_con/public/productos/masvendidos";
    String url_menosVendidos= "http://192.168.0.2/tesis_con/public/productos/menosVendidos";
