...
public class Fragment_vendedor_clientes extends Fragment {
    ...
    String url_recibir_clientes = "http://192.168.0.7/tesis_con/public/clientes";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_vendedor_clientes, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        navHostFragment = (NavHostFragment) getActivity().getSupportFragmentManager().findFragmentById(R.id.fragmentContClientVendedor);
