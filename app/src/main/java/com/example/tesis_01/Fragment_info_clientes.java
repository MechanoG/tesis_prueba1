...
public class Fragment_info_clientes extends Fragment {
    ...
    RecyclerView clie_statInf;

    ArrayList<Cliente_statInfo> list_client;
    ...
    String url_clie_stats = "https://23a8-37-19-221-239.ngrok-free.app/tesis_con/public/clientes/comprasclientes";
    String getUrl_clie_menosStats = "https://23a8-37-19-221-239.ngrok-free.app/tesis_con/public/clientes/comprasMenosclientes";
    @Override
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_info_clientes, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        clie_statInf = view.findViewById(R.id.cli_stat_recy);
    ...
    private void buildRecycleview(){
        ...
        Clie_stat_RecViewAdapt adapClieStat = new Clie_stat_RecViewAdapt(list_client, getContext(), getParentFragmentManager());

        //agregar layout manager
        //al recycle view
        LinearLayoutManager manager = new LinearLayoutManager(getContext());
        clie_statInf.setHasFixedSize(true);

        //se le da el layout managerr al recycle view
        clie_statInf.setLayoutManager(manager);

        //Se establece el adaptador al recycle View
        clie_statInf.setAdapter(adapClieStat);
